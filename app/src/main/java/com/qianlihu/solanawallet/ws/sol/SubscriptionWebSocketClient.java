...
import com.qianlihu.solanawallet.rpc.type.RpcNotificationResult;
import com.qianlihu.solanawallet.rpc.type.RpcRequest;
import com.qianlihu.solanawallet.rpc.type.RpcResponse;
import com.qianlihu.solanawallet.ws.sol.listeners.NotificationEventListener;
...
public class SubscriptionWebSocketClient extends WebSocketClient {
    ...
    public static SubscriptionWebSocketClient getInstance() {
        URI endpointURI;
        URI serverURI;

        try {
//            endpointURI = new URI(endpoint);
//            serverURI = new URI(endpointURI.getScheme() == "https" ? "ws" : "ws" + "://" + endpointURI.getHost());
            serverURI = new URI(Constant.SOL_WS);
