package com.qianlihu.solanawallet.utils.wallet_utils.crypto;
...
public class Secp256k1 {
     ...
     * (repeated com.qianlihu.solanawallet.application of the EC group operation) of the secp256k1 base point
     * with the integer p.
     *
     * @param p input
     * @return point
