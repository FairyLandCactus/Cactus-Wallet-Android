package com.qianlihu.solanawallet.service;
...
import com.qianlihu.solanawallet.wc.WalletConnectActions;
import com.qianlihu.solanawallet.wc.walletconnect.SignType;
import com.qianlihu.solanawallet.wc.walletconnect.WCClient;
import com.qianlihu.solanawallet.wc.walletconnect.WCRequest;
...
import static com.qianlihu.solanawallet.wc.C.WALLET_CONNECT_CLIENT_TERMINATE;
import static com.qianlihu.solanawallet.wc.C.WALLET_CONNECT_COUNT_CHANGE;
import static com.qianlihu.solanawallet.wc.C.WALLET_CONNECT_FAIL;
import static com.qianlihu.solanawallet.wc.C.WALLET_CONNECT_NEW_SESSION;
import static com.qianlihu.solanawallet.wc.C.WALLET_CONNECT_REQUEST;
...
public class WalletConnectService extends Service {
    ...
    private void setupClient(WCClient client) {
        client.setOnSessionRequest((id, peer) -> {
            ...
            Log.i("duan==server", "setupClient1");
        ...
        client.setOnFailure(throwable -> {
            ...
            if (queueHasNoErrors()) {
                ...
                Log.i("duan==server", "setupClient2");
        ...
        client.setOnEthSign((id, message) -> {
            ...
            Log.i("duan==server", "setupClient3");
        ...
        client.setOnEthSignTransaction((id, transaction) -> {
            ...
            Log.i("duan==server", "setupClient4");
            switchToWalletConnectApprove(client.sessionId());
            startMessagePump();
            return Unit.INSTANCE;
        });
        ...
        client.setOnEthSendTransaction((id, transaction) -> {
            ...
            Log.i("duan==server", "setupClient5");
            switchToWalletConnectApprove(client.sessionId());
            startMessagePump();
            return Unit.INSTANCE;
        });
...
//        Log.i("duan==server", "checkMessages");
    ...
    private boolean queueHasNoErrors() {
        Log.i("duan==server", "queueHasNoErrors");
