 ...
 * version: 1.0.0
 */
public class DappEthListAdapter extends BaseQuickAdapter<DappInfoBean, BaseViewHolder> {

    private int listSize = 0;

    public DappEthListAdapter(@Nullable List<DappInfoBean> data) {
    ...
    protected void convert(BaseViewHolder helper, DappInfoBean item) {
        ...
        helper.setText(R.id.tv_dec, mContext.getString(R.string.dapp_eth_item_1));
