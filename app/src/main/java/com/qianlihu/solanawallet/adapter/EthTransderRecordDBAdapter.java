 ...
 * version: 1.0.0ko-
 */
public class EthTransderRecordDBAdapter extends BaseQuickAdapter<EthTransferRecordDB, BaseViewHolder> {

    private String mPuk = "";
    private double usd = 0.0;
    public EthTransderRecordDBAdapter(@Nullable List<EthTransferRecordDB> data, String puk, double usd) {
    ...
    @Override
    protected void convert(BaseViewHolder helper, EthTransferRecordDB db) {
