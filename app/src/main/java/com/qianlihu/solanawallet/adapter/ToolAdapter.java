 ...
 * version: 1.0.0
 */
public class ToolAdapter extends BaseQuickAdapter<TokenTypeBean, BaseViewHolder> {
    public ToolAdapter(@Nullable List<TokenTypeBean> data) {
        super(R.layout.item_tool, data);
    }
